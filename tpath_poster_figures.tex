...
\node [below=5cm of belownorth, olive] {$\frac{x_{1} + x_{2}}{x_{0}}$};
\node [above=4cm of abovesouth, gray] {$\frac{x_{0} x_{1} + x_{0} x_{2} + x_{1} + x_{2}}{x_{0} x_{1} x_{2}}$};

\node [below=5.1cm of leftdiamondWest, magenta] {$\frac{x_{0} + 1}{x_{1}}$};
\node [below=5.1cm of rightdiamondEast, green] {$\frac{x_{0} + 1}{x_{2}}$};
