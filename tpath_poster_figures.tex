...
\draw [style = thick] (0,0) ..  controls (3.7,1) and (3.8,3.9)   .. (0,4); % the middle arc 
\draw[style = thick, blue] (0,4) .. controls (0.8,1) and (1,2) .. (1.2,2.2);  % the radius (tagged plain) arc
\draw[style = thick, red] (0,4) -- (1.2,2.2);% node[pos=0.5, right=1pt] {$\iota(\ell)$};  
...
\draw [style = thick] (0,0) ..  controls (3.7,1) and (3.8,3.9)   .. %node[pos =0.4,left=2pt] {$2$}  
(0,4);
\draw[style = thick,red] (0,4) -- %node[pos =0.3,right=1pt] {$3$}  
(1.2,2.2);
\draw[style = thick,blue] (1.2,2.2) -- %node[pos =0.4,right=1pt] {$4$}  
(0,0);
\draw [fill=violet] (1.2,2.2) circle (.3ex); %puncture
\draw [fill=green] (0,0) circle (.3ex);
\draw [fill=green] (0,4) circle (.3ex);
...
\draw[style = thick,red] (1.2,2.2) -- (0,0);
\draw [fill=violet] (1.2,2.2) circle (.3ex); %puncture
\draw [fill=green] (0,0) circle (.3ex);
\draw [fill=green] (0,4) circle (.3ex);
\end{scope}
...
\draw[magenta] \TikzNorthWest -- \TikzSouthEast;
\end{scope}
\draw[magenta, <->, very thick] (4,1) -- (6,1);
\begin{scope}[thick,xshift = 7cm]
\draw[style = thick]  (0,0) rectangle \TikzNorthEast; 
\draw[magenta] (0,0) -- \TikzNorthEast;
\end{scope}
\end{scope}
