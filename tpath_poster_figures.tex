...
\newcommand \SelfFoldedLocalTriangulation[1] { % USED
 ...
 \newcommand\MacroTtwoTpathChubby{
	 ...
	 \draw[rounded corners = 20pt] (-4,4)  -- (0,7) node[pos=0.8,above,black]{$1$} -- (4,4);
	 
	 \draw[rounded corners = 15pt] (0,0) -- 
	 (-2.5,4) %-- (-3,4) 
	 --  (0,6) node[pos=0.8,right,black]{$2$}  -- (4,4);
	 
	 \draw[thick] (0,0) -- (0,2.9) node[pos=0.8, right=2pt,black]{$r$};
	
	\draw[style = thick, rounded corners = 20pt]
	(0,0) .. controls (-1.5,2) and (-2,3) .. (0,5) .. 
	controls (2,3)  and (2,2) .. (0,0) node[pos=0.4, above=2pt,black] {$\ell$};
	
	\draw
	(0,0) -- %node[pos=0.5, right] {$b_3$} 
	(4,4) --
	%node[pos=0.5, above] {$b_4$} 
	(0,8) -- 
	node[pos=0.5, left] {}
	 (-4,4) --
	%node[pos=0.5, below] {$b_2$}  
	(0,0);	
	\end{scope}
...
%\newcommand \TikzPolygonTpathSixBad[1]{
%\begin{tikzpicture}[scale={#1}, rotate=-90]
%	\MacroTtwoLiftedPolygon
%	\begin{scope}[TPathStyle]
%	\draw [->, rounded corners = \rdPolygonTpath pt] (-4,-4) -- (-4,0) -- (0,-4) -- (0,0) [rounded corners = 0] -- (0,4)   [rounded corners=\rdPolygonTpath pt] -- (-4,4)  -- (0,0) -- (4,0);
...
\begin{scope}[NonOrientedTriangulationStyle]
\draw[postaction={decorate}]  (s) -- (vR) node[pos=0.5,left] {$b_1$};
\draw[postaction={decorate}]  (vR) -- (vL) node[pos=0.5,below]{$b_2$};
\draw[postaction={decorate}]  (vL) -- (t) node[pos=0.5,right] {$b_3$};
\draw[postaction={decorate}]  (t) --(s) node[pos=0.5,above] {$b_4$};
\draw [postaction={decorate}] (t) ..  controls(3.5,0.4) and (3.5,2) .. (vR) node[left, pos=0.3] {$1$};
\draw [postaction={decorate}] (t) ..  controls (3.7,1) and (3.8,3.9)   .. (vL) node[right, pos=0.5] {$2$};%;
\draw [NooseArrowAtPosStyleSix] (vL) ..  controls (3.9,1.4)  and (0.7,0.1)  .. (vL) node[pos=0.7, right,above] {$\ell$}; %loop
\draw[postaction={decorate}] (vL) -- (1.2,2.2) node[left, pos=0.7] {$r$};
\end{scope}
 } 
  \newcommand\TikzTtwoIdealTriangulationWithNumberLabels[1]{ % USED
	...
	node[pos=0.6, left=2pt] {\Large{$\ga$}}; % red gamma
	\MacroTtwoTriangulationVertices
	\draw [fill=violet] (1.2,2.2) circle (.6ex); %puncture
	\draw [fill=olive] (t) circle (.6ex); % node[above,olive] {$t$};
	\draw [fill=olive] (vL) circle (.6ex); % node[left,olive] {$v$}; %vL
	\draw [fill=olive] (s) circle (.6ex); % node[right,olive] {$s$};
	\draw [fill=olive] (vR) circle (.6ex); % node[below,olive] {$z$}; %vR
	\end{scope}
\end{tikzpicture}
}  
...
\node at (0.4*\Tikzn,0.4*\Tikzn) [right]{$1$};
\node at (-0.4*\Tikzn,0.4*\Tikzn) [above]{$2$};
\node at (-0.6*\Tikzn,-0.6*\Tikzn) [right]{$3$};
\node at (0.4*\Tikzn,-0.4*\Tikzn) [left]{$\tau$};
\node at (1.3*\Tikzn,0) {$b_1$}; \node at (-1.3*\Tikzn,0) {$b_3$};
\node at (0,1.3*\Tikzn) {$b_2$}; \node at (0,-1.3*\Tikzn) {$b_4$};
\node at (-0.7*\Tikzn,0) [red] {$\ga$};
\end{tikzpicture}
}
...
\node at (1.3*\Tikzn,0) {\tiny$b_1$}; 

\node at (1.8*\Tikzn,0) {}; \node at (-1.8*\Tikzn,0) {}; 
\end{tikzpicture}
}
\newcommand\TikzNooseTpathOne[1]{
\begin{tikzpicture}[scale={#1}]
\MacroNooseTriangulation{gray}
...
\newcommand\TikzNooseTpathThree[1]{
\begin{tikzpicture}[scale={#1}]
\MacroNooseTriangulation{gray}
%\draw [TPathStyle, PathArrowAtPosStyleFour] (-\Tikzn,\Tikzn) -- (-\Tikzn,-\Tikzn); 
...
\newcommand\TikzNooseTpathFour[1]{
\begin{tikzpicture}[scale={#1}]
\MacroNooseTriangulation{gray}
%\draw [TPathStyle, PathArrowAtPosStyleFour] (-\Tikzn,-\Tikzn) -- (\Tikzn,-\Tikzn); 
...
-- (-\Tikzn,-\Tikzn);
\node at (0.4*\Tikzn,0.4*\Tikzn) [right]{$1$};
\node at (-0.4*\Tikzn,0.5*\Tikzn) [above]{$2$};
\node at (-0.5*\Tikzn,-0.5*\Tikzn) {$3$};
\node at (0.5*\Tikzn,-0.5*\Tikzn) [left]{$0$};
\node at (1.3*\Tikzn,0) {$b_1$}; \node at (-1.3*\Tikzn,0) {$b_3$};
\node at (0,1.3*\Tikzn) {$b_2$}; \node at (0,-1.3*\Tikzn) {$b_4$};
\node[rotate=50] at (0.2*\Tikzn,0.74*\Tikzn) [red] {$\ga$};
\end{tikzpicture}
}
%\newcommand\MacroDrawBlueDot[2]{
%\node[style=thick,fill=blue,blue,circle,minimum width=2.5pt,inner sep=0pt,draw] at (#1,#2) {};
...
\node at (0.4*\Tikzn,0.4*\Tikzn) [right]{\tiny$1$};
\node at (-0.4*\Tikzn,0.5*\Tikzn) [above]{\tiny$2$};
\node at (-0.5*\Tikzn,-0.5*\Tikzn) {\tiny$3$};
\node at (0.5*\Tikzn,-0.5*\Tikzn) [right]{\tiny$0$};
\node at (1.3*\Tikzn,0) {}; \node at (-1.3*\Tikzn,0) {};
%\node at (0,1.3*\Tikzn) {$b_2$}; \node at (0,-1.3*\Tikzn) {$b_4$};
...
\newcommand\TikzNotNooseTpathOne[1]{
\begin{tikzpicture}[scale={#1}]
\MacroNotNooseTriangulation{gray}
...
\draw [PathArrowAtPosStyleEnd]  (\Tikzn,-\Tikzn) -- (-\Tikzn,-\Tikzn); \node[black] at (0,-1.3*\Tikzn) {\tiny$b_4$};
\end{scope}
\end{tikzpicture}
}
\newcommand\TikzNotNooseTpathTwo[1]{
\begin{tikzpicture}[scale={#1}]
\MacroNotNooseTriangulation{gray}
\MacroNotNooseTpathDrawLabels
...
\draw [PathArrowAtPosStyleFourSmall] (\Tikzn,\Tikzn) -- (-\Tikzn,\Tikzn); \node[black] at (0,1.3*\Tikzn) {\tiny$b_2$};
...
\newcommand\TikzNotNooseTpathThree[1]{
\begin{tikzpicture}[scale={#1}]
\MacroNotNooseTriangulation{gray}
\MacroNotNooseTpathDrawLabels
...
\draw [fill=green] (0,4) circle (.6ex);
\draw [fill=green] (4,0) circle (.6ex);
\draw [fill=green] (4,4) circle (.6ex);
\draw [fill=violet] (1.2,2.2) circle (.6ex); %puncture
  }
%%%%%%%%%%%
...
\draw [fill=green] (4,4) circle (.6ex);
 ...
 \path[fill] (1,2.5) -- (1.1,2.8) -- (1.3,2.5) -- cycle; % the top notching (right)
\path[fill] (1,2.5) -- (0.9,2.2) -- (0.7,2.5) -- cycle; % the top notching (left)

 \path[fill] (1,1.9) -- (1.1,1.6) -- (1.3,1.9) -- cycle; % the bottom notching (right)
\path[fill] (1,1.9) -- (0.9,2.2) -- (0.7,1.9) -- cycle; % the bottom notching (left)
 }
...
\draw [style = thick] (0,0) ..  controls (3.7,1) and (3.8,3.9)   .. (0,4); % the middle arc 
\draw[style = thick] (0,4) .. controls (0.8,1) and (1,2) .. (1.2,2.2);  % the radius (tagged plain) arc
\draw[style = very thick] (0,4) -- (1.2,2.2) node[pos=0.5, right=1pt] {$\iota(\ell)$};  
\path[fill] (1,2.5) -- (1.1,2.8) -- (1.3,2.5) -- cycle; % the notching (right)
\path[fill] (1,2.5) -- (0.9,2.2) -- (0.7,2.5) -- cycle; % the notching (left)
...
\draw [fill=violet] ($(P)+(#1)$) circle (.1); %puncture
 \end{scope}
 } % CURRENT
 
\newcommand\MacroTikzDNorth{
\MacroTikzDFourClustersTriangle{north}
\draw ($(L)+(north)$) -- node[below, pos=0.6]{\small $x_1$} ($(P)+(north)$) -- node[below, pos=0.3]{\small $x_2$} ($(R)+(north)$);
\draw[rounded corners=10pt] ($(L)+(north)$) -- ($(0,\TikzH*0.5)+(north)$) node[above,pos=0.95]{\small $x_0$} -- ($(R)+(north)$);
 }
 
 \newcommand\MacroTikzDWest{
\MacroTikzDFourClustersTriangle{west}
\draw ($(P)+(west)$) -- node[sloped,rotate=90,pos=0.2]{$\mysmallbowtie$}  ($(R)+(west)$);
\draw[rounded corners=10pt] ($(L)+(west)$) -- ($(0,\TikzH*0.5)+(west)$) -- ($(R)+(west)$);
\draw[rounded corners=10pt] ($(R)+(west)$) -- ($(P)+(west)+(0,-0.6)$) -- ($(P)+(west)$);
 }
 \newcommand\MacroTikzDEast{
\MacroTikzDFourClustersTriangle{east}
\draw ($(L)+(east)$) -- node[sloped,rotate=90,pos=0.8]{$\mysmallbowtie$} ($(P)+(east)$) ;
\draw[rounded corners=10pt] ($(L)+(east)$) -- ($(0,\TikzH*0.5)+(east)$) -- ($(R)+(east)$);
\draw[rounded corners=10pt] ($(L)+(east)$) -- ($(P)+(east)+(0,-0.6)$) -- ($(P)+(east)$);
 }
 
 
 \newcommand\MacroTikzDBelowNorth{
 \MacroTikzDFourClustersTriangle{belownorth}
\draw  ($(L)+(belownorth)$)  --  ($(P)+(belownorth)$) --  ($(top)+(belownorth)$)  ($(P)+(belownorth)$) -- ($(R)+(belownorth)$);
 }
...
\draw  ($(R)+(leftdiamondNorth)$)  --  ($(P)+(leftdiamondNorth)$) --  ($(top)+(leftdiamondNorth)$) ;
\draw[rounded corners=15pt] ($(R)+(leftdiamondNorth)$) -- ($(-0.6,-0.6)+(leftdiamondNorth)$) -- ($(top)+(leftdiamondNorth)$);
 }
 \newcommand\MacroTikzDleftdiamondWest{
 \MacroTikzDFourClustersTriangle{leftdiamondWest}
\draw  ($(R)+(leftdiamondWest)$)  -- node[sloped,rotate=90,pos=0.8]{$\mysmallbowtie$}  ($(P)+(leftdiamondWest)$);
\draw[rounded corners=20pt] ($(R)+(leftdiamondWest)$) -- ($(-0.8,-1)+(leftdiamondWest)$) -- ($(top)+(leftdiamondWest)$);
\draw[rounded corners=10pt] ($(R)+(leftdiamondWest)$) -- ($(P)+(leftdiamondWest)+(0,-0.6)$) -- ($(P)+(leftdiamondWest)$);
 }
\newcommand\MacroTikzDleftdiamondEast{
 \MacroTikzDFourClustersTriangle{leftdiamondEast}
\draw  ($(P)+(leftdiamondEast)$) --  node[pos=0.25]{$\mysmallbowtie$} ($(top)+(leftdiamondEast)$) ;
\draw[rounded corners=15pt] ($(R)+(leftdiamondEast)$) -- ($(-0.6,-0.6)+(leftdiamondEast)$) -- ($(top)+(leftdiamondEast)$);
 \draw[rounded corners=10pt] ($(top)+(leftdiamondEast)$) -- ($(P)+(leftdiamondEast)+(0.5,0)$) -- ($(P)+(leftdiamondEast)$);
 }
 \newcommand\MacroTikzDleftdiamondSouth{
 \MacroTikzDFourClustersTriangle{leftdiamondSouth}
\draw  ($(R)+(leftdiamondSouth)$)  --  node[sloped,rotate=90,pos=0.8]{$\mysmallbowtie$} ($(P)+(leftdiamondSouth)$) --  node[pos=0.25]{$\mysmallbowtie$} ($(top)+(leftdiamondSouth)$) ;
\draw[rounded corners=15pt] ($(R)+(leftdiamondSouth)$) -- ($(-0.6,-0.6)+(leftdiamondSouth)$) -- ($(top)+(leftdiamondSouth)$);
 } 
 % left diamond ends
...
\draw  ($(L)+(rightdiamondNorth)$)  --  ($(P)+(rightdiamondNorth)$) --  ($(top)+(rightdiamondNorth)$) ;
\draw[rounded corners=15pt] ($(L)+(rightdiamondNorth)$) -- ($(0.6,-0.6)+(rightdiamondNorth)$) -- ($(top)+(rightdiamondNorth)$);
 }
 
   \newcommand\MacroTikzDrightdiamondWest{
 \MacroTikzDFourClustersTriangle{rightdiamondWest}
\draw  ($(P)+(rightdiamondWest)$) --  node[pos=0.25]{$\mysmallbowtie$} ($(top)+(rightdiamondWest)$) ;
\draw[rounded corners=15pt] ($(L)+(rightdiamondWest)$) -- ($(0.6,-0.6)+(rightdiamondWest)$) -- ($(top)+(rightdiamondWest)$);
\draw[rounded corners=10pt] ($(top)+(rightdiamondWest)$) -- ($(P)+(rightdiamondWest)+(-0.5,0)$) -- ($(P)+(rightdiamondWest)$);
 }
  \newcommand\MacroTikzDrightdiamondEast{
 \MacroTikzDFourClustersTriangle{rightdiamondEast}
\draw  ($(L)+(rightdiamondEast)$)  -- node[sloped,rotate=90,pos=0.8]{$\mysmallbowtie$}  ($(P)+(rightdiamondEast)$);
\draw[rounded corners=20pt] ($(L)+(rightdiamondEast)$) -- ($(0.8,-1)+(rightdiamondEast)$) -- ($(top)+(rightdiamondEast)$);
\draw[rounded corners=10pt] ($(L)+(rightdiamondEast)$) -- ($(P)+(rightdiamondEast)+(0,-0.6)$) -- ($(P)+(rightdiamondEast)$);
 } 
 \newcommand\MacroTikzDrightdiamondSouth{
 \MacroTikzDFourClustersTriangle{rightdiamondSouth}
\draw  ($(L)+(rightdiamondSouth)$)  --  node[sloped,rotate=90,pos=0.8]{$\mysmallbowtie$} ($(P)+(rightdiamondSouth)$) -- node[pos=0.25]{$\mysmallbowtie$} ($(top)+(rightdiamondSouth)$) ;
\draw[rounded corners=15pt] ($(L)+(rightdiamondSouth)$) -- ($(0.6,-0.6)+(rightdiamondSouth)$) -- ($(top)+(rightdiamondSouth)$);
}
\newcommand\MacroTikzDAboveSouth{
\MacroTikzDFourClustersTriangle{abovesouth}
\draw  ($(L)+(abovesouth)$)  --  node[sloped,rotate=90,pos=0.8]{$\mysmallbowtie$} ($(P)+(abovesouth)$) -- node[pos=0.25]{$\mysmallbowtie$} ($(top)+(abovesouth)$)  ($(P)+(abovesouth)$) -- node[sloped,rotate=90,pos=0.2]{$\mysmallbowtie$} ($(R)+(abovesouth)$);
 }
\newcommand\MacroTikzDSouth{
\MacroTikzDFourClustersTriangle{south}
\draw ($(L)+(south)$) -- node[sloped,rotate=90,pos=0.8]{$\mysmallbowtie$} ($(P)+(south)$) -- node[sloped,rotate=90,pos=0.2]{$\mysmallbowtie$} ($(R)+(south)$);
\draw[rounded corners=10pt] ($(L)+(south)$) --  ($(0,\TikzH*0.5)+(south)$) -- ($(R)+(south)$);
}
...
\node [right= 9cm of north, yshift=-2cm] {$x_0$};
\node [above=5.5cm of leftdiamondWest] {$x_2$};
\node [above=5.5cm of rightdiamondEast] {$x_1$};

\node [below=5cm of belownorth] {$\frac{x_{1} + x_{2}}{x_{0}}$};
\node [above=4cm of abovesouth] {$\frac{x_{0} x_{1} + x_{0} x_{2} + x_{1} + x_{2}}{x_{0} x_{1} x_{2}}$};

\node [below=5.1cm of leftdiamondWest] {$\frac{x_{0} + 1}{x_{1}}$};
\node [below=5.1cm of rightdiamondEast] {$\frac{x_{0} + 1}{x_{2}}$};

\node [below=2.7cm of leftdiamondNorth, xshift=-0.7cm] {$\frac{x_{0} x_{2} + x_{1} + x_{2}}{x_{0} x_{1}}$};
\node [below=2.7cm of rightdiamondNorth, xshift=0.7cm] {$\frac{x_{0} x_{1} + x_{1} + x_{2}}{x_{0} x_{2}}$};
