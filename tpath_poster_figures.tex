...
\draw[style = thick] (\TikzW,0) .. controls (\TikzW*0.95,0.2) and (\TikzW*0.95,\TikzH*0.8) .. (rightpuncture) node[pos=0.5,right]{$t$};  % the bridging (tagged plain) arc
...
\path[fill, gray] (\TikzTPW,\TikzTPH+0.5) -- (\TikzTPW+0.1,\TikzTPH+0.8) -- (\TikzTPW+0.3,\TikzTPH+0.5) -- cycle; % the notching (right)
 ...
 \draw [fill=green] (0,0) circle (.3ex);
\draw [fill=green] (0,\TikzH) circle (.3ex);
\draw [fill=green] (\TikzW,0) circle (.3ex);
\draw [fill=green] (topright) circle (.3ex);
\draw [fill=violet] (1.2,2.2) circle (.3ex); %puncture
...
\draw[violet, fill] (0,1.5) circle (0.2ex);
\draw[violet, fill] (0,2.5) circle (0.2ex);
\begin{scope}[yshift=2cm]
\foreach \myangle in {30,-60,120,-150}
{\draw [violet,fill](\myangle:\localradius) circle (0.2ex);}
\end{scope}
